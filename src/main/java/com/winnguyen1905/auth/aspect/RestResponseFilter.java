package com.winnguyen1905.auth.aspect;
...
// implements ResponseBodyAdvice<Object>
{
  ...
  // RestResponse.builder().statusCode(statusCode).build();
  // if (statusCode > 399)
  // return body;
  // else {
  // restResponse.setData((Object) body);
  // if (returnType.getMethodAnnotation(MetaMessage.class) instanceof MetaMessage
  // message)
