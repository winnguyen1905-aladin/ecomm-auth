...
public class VendorController {
    ...
    public Mono<ResponseEntity<VendorVm>> getVendorByAccountId(@PathVariable UUID accountId) {
    ...
    public Mono<ResponseEntity<VendorVm>> createVendor(@RequestBody VendorVm vendorVm) {
